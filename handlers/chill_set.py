...
def register_handlers_chill_set(dp: Dispatcher):
    # Кнопки состояния "Отдых"
    dp.register_callback_query_handler(process_btn_menu, lambda c: c.data == 'btn_menu', state=MenuStage.chill)
    dp.register_callback_query_handler(process_menu_btn1, lambda c: c.data == 'menu_btn1', state=MenuStage.chill)
    dp.register_callback_query_handler(process_menu_btn2, lambda c: c.data == 'menu_btn2', state=MenuStage.chill)
    dp.register_callback_query_handler(process_menu_btn3, lambda c: c.data == 'menu_btn3', state=MenuStage.chill)
    dp.register_callback_query_handler(process_menu_btn4, lambda c: c.data == 'menu_btn4', state=MenuStage.chill)
    dp.register_callback_query_handler(process_inv_info_btn, lambda c: 'inv_info_btn' in c.data, state=MenuStage.chill)
